...
Project.create(
    ...
    summary: 'All the power of a robotics platform in an educational tool', 
    
    instructions: 'How to Robotics Kit',
    
    tags: ["1"],
    
    grade_level: "6-12",
    
    image: 'https://s3-us-west-2.amazonaws.com/diagon-alley-devel-storage/project_images/Mindstorm.jpg'
    )
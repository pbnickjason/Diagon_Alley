    ...
    palette: [
      ...
      },
      {
        ...
        'blocks': [
          ...
          {'block': 'myObject.myFunction(param);'},
        ]
      },
      {
        'name': 'Logic',
      ...
      },
      {
        ...
        'color': 'dark blue',
        'blocks': [
          //{'block': 'var ros = new ROSLIB.Ros({url : \'ws://\' + location.host + \':9090\'})'},
          //{'block': 'ros.on(arg, function(param) {\n  __\n})'},
          //{'block': 'var velocityTopic = new ROSLIB.Topic({\n ros : ros,\n name : \'/cmd_vel\',\n messageType : \'geometry_smgs/Twist\'\n})'},
          //{'block': 'new ROSLIB.Message(param)'},
          //{'block': 'var twist = new ROSLIB.Message({linear:{x: 0, y: 0, z: 0}, angular: {x: 0, y: 0, z: 0}})'},
          //{'block': 'velocityTopic.publish(twist)'}
          {'block': 'ros_init()'},
          {'block': 'new_topic(ros_api, topic_name, topic_type)'},
          {'block': 'geometry_msgs_Twist(ros_api, linear_x, linear_y, linear_z, angular_x, angular_y, angular_z)'},
          {'block': 'setTimeout(myFunction, time)'},
          {'block': 'ros_loop(myFunction, time)'}
        ]
      },
    ]
  },
